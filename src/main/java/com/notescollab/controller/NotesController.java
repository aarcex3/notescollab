...
public class NotesController {
    ...
    @PutMapping("/notes/{id}")
    public ResponseEntity<?> updateNotesById(@RequestBody NotesDetails notesDetails, @PathVariable("id") Integer id)
            throws Exception {
    ...
    public ResponseEntity<?> shareNotes(@PathVariable("id") Integer id, @RequestParam("userid") Long shareUserid)
            throws Exception {
        ...
        try {
            ...
            if (note == null) {
                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                        .body("you don't have permission to share this notes!");
            }

            MyUser user = userRepository.getUserById(shareUserid);
            if (user == null) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body("User with id " + shareUserid + " does not exits!");
            }
